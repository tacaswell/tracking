...
class Gnuplot
{
    ...
    public:
        ...
        Gnuplot(const std::vector<float> &x,
    ...
    Gnuplot& set_pointsize(const float pointsize = 1.0);
    ...
    /// set axis - ranges
    Gnuplot& set_xrange(const float iFrom,
                        const float iTo);
    /// set y-axis - ranges
    Gnuplot& set_yrange(const float iFrom,
                        const float iTo);
    /// set z-axis - ranges
    Gnuplot& set_zrange(const float iFrom,
                        const float iTo);
    ...
    Gnuplot& set_cbrange(const float iFrom, const float iTo);
    ...
    Gnuplot& plot_slope(const float a,
                        const float b,
                        const std::string &title = "");
