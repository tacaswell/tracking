...
//
 Gnuplot::Gnuplot(const std::vector<float> &x,
...
//------------------------------------------------------------------------------
//
/// Plots a 2d graph from a list of floats: x
//
template<typename X>
...
//------------------------------------------------------------------------------
//
/// Plots a 2d graph from a list of floats: x y
//
...
//------------------------------------------------------------------------------
//
// Plots a 3d graph from a list of floats: x y z
//
...
//
Gnuplot& Gnuplot::set_xlogscale(const float base)
{
    std::ostringstream cmdstr;
...
//
Gnuplot& Gnuplot::set_ylogscale(const float base)
{
    std::ostringstream cmdstr;
...
//
Gnuplot& Gnuplot::set_zlogscale(const float base)
{
    std::ostringstream cmdstr;
...
//
Gnuplot& Gnuplot::set_pointsize(const float pointsize)
{
    std::ostringstream cmdstr;
...
//
// set the xrange
Gnuplot& Gnuplot::set_xrange(const float iFrom,
                             const float iTo)
{
    std::ostringstream cmdstr;
...
// set the yrange
//
Gnuplot& Gnuplot::set_yrange(const float iFrom,
                             const float iTo)
{
    std::ostringstream cmdstr;
...
// set the zrange
//
Gnuplot& Gnuplot::set_zrange(const float iFrom,
                             const float iTo)
{
    std::ostringstream cmdstr;
...
//
Gnuplot& Gnuplot::set_cbrange(const float iFrom,
                              const float iTo)
{
    std::ostringstream cmdstr;
...
//
Gnuplot& Gnuplot::plot_slope(const float a,
                             const float b,
                             const std::string &title)
{
    std::ostringstream cmdstr;
...
//------------------------------------------------------------------------------
//
// Plots a 2d graph from a list of floats (x) saved in a file
//
...
//------------------------------------------------------------------------------
//
// Plots a 2d graph from a list of floats (x y) saved in a file
//
...
//------------------------------------------------------------------------------
//
// Plots a 2d graph with errorbars from a list of floats (x y dy) in a file
//
...
//------------------------------------------------------------------------------
//
// Plots a 3d graph from a list of floats (x y z) saved in a file
//
